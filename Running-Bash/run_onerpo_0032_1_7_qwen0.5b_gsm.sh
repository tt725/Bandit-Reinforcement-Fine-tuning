...
python3 -m verl.trainer.main_ppo_bandit \
    algorithm.adv_estimator=onerpo \
    data.train_files=$TRAIN_DATA_DIR \
    data.val_files=$VAL_DATA_DIR \
   +data.extra_sampling_size=7 \
   ...
   +algorithm.norm_adv_by_std_in_grpo=True \
    ...
    trainer.experiment_name='onerpo_0032_1_7_Qwen0.5B_math' \
    trainer.n_gpus_per_node=1 \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=100 \
    trainer.total_epochs=100 $@ > onerpo_0032_1_7_Qwen0.5B_math.log 2>&1 &